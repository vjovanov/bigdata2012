...
% Data Serialization
For serialization of data we used LMS code generation to achieve minimal
...
% Spark
For the sake of showing comparison between the Hadoop based frameworks and the
...
\code{Vector} abstraction that has abstract methods for arithmetic vector
...
The \code{Vector} class extension is only 100 lines of Scala code and was
