...
In Section \ref{sec:programming-model} we have shown that the \code{DColl}
...
operations \code{map}, \code{flatMap} and \code{filter} through the underlying
...
operations provide more oppurtunities for other compiler optimizations.
