...
% \item \todo{link generality to optimizations}We implement the \tool framework
% for big data processing. \tool has a slightly restricted and high level
% programming model but still applies relational, domain specific and compiler
